...
namespace AE.O365.GetFiles.CSApp.Common.Authorize;
...
public class AuthenticationManager : IDisposable
{
    ...
    private readonly string defaultAADAppId = "986002f6-c3f6-43ab-913e-78cca185c392";

    public AuthenticationManager(string strAADAppId)
    {
        defaultAADAppId = strAADAppId;
    }
